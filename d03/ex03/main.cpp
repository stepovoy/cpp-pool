...
int main(void)
{
	...
	NinjaTrap ninjaTrap("Ninja Robot");
	ninjaTrap.rangedAttack(str);
	ninjaTrap.meleeAttack(str);
	std::cout << ninjaTrap.name << " hit points: " << ninjaTrap.hitPoints << std::endl;
	ninjaTrap.takeDamage(30);
	std::cout << ninjaTrap.name << " hit points: " << ninjaTrap.hitPoints << std::endl;
	ninjaTrap.takeDamage(75);
	std::cout << ninjaTrap.name << " hit points: " << ninjaTrap.hitPoints << std::endl;
	ninjaTrap.beRepaired(60);
	std::cout << ninjaTrap.name << " hit points: " << ninjaTrap.hitPoints << std::endl;
	ninjaTrap.beRepaired(45);
	std::cout << ninjaTrap.name << " hit points: " << ninjaTrap.hitPoints << std::endl;
	ninjaTrap.ninjaShoebox(fragTrap);
	std::cout << fragTrap.name << "'s level is: " << fragTrap.level << std::endl;
	ninjaTrap.ninjaShoebox(scavTrap);
	std::cout << scavTrap.name << "'s level is: " << scavTrap.level << std::endl;
	ninjaTrap.ninjaShoebox(ninjaTrap);
	std::cout << ninjaTrap.name << "'s level is: " << ninjaTrap.level << std::endl;
	ClapTrap anotherNinjaTrap("Alternative Ninja Robot");
	ninjaTrap.ninjaShoebox(anotherNinjaTrap);
	std::cout << anotherNinjaTrap.name << "'s level is: " << anotherNinjaTrap.level << std::endl;
